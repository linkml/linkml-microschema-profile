# Contributing to common-data-elements-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
common-data-elements-schema. These guidelines are not strict rules.
...
The common-data-elements-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the common-data-elements-schema technical leads
...
[issues]: https://github.com/diatomsRcool/common-data-elements-schema/issues/
[pulls]: https://github.com/diatomsRcool/common-data-elements-schema/pulls/
