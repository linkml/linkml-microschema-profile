...
import linkml_microschema_profile.datamodel.linkml_microschema_profile_clinical
...
def test_valid_data_files(filepath):
    ...
    tgt_class = getattr(
        linkml_microschema_profile.datamodel.linkml_microschema_profile_clinical,
        target_class_name,
    )
